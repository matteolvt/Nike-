...
const MenClothes = () => {
  ...
  const products = [
    ...
    {
      image: "./images/A_black_image.jpg",
      name: "FC Barcelona Academy Pro Home Nike Dri-FIT for men",
    ...
    },
    {
      image: "./images/A_black_image.jpg",
      name: "FC Barcelona Strike",
      description: "Mesh football tracksuit Nike Dri-FIT for men",
      colors: 1,
      price: 139.99,
    },
    {
      image: "./images/A_black_image.jpg",
      name: "FC Barcelona Club Fleece",
      description: "Nike Basketball Men's Hoodie",
      colors: 1,
      price: 69.99,
    },
